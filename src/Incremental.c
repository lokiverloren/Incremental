...
void incremental_create_actions (Incremental* self) {
	...
	_tmp4_ = self->hide_terminal_accelerator;
	_tmp5_ = g_strdup (_tmp4_);
	_tmp6_ = g_new0 (gchar*, 1 + 1);
	_tmp6_[0] = _tmp5_;
	_tmp7_ = _tmp6_;
	_tmp7__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.toggle-terminal", _tmp7_);
	_tmp7_ = (_vala_array_free (_tmp7_, _tmp7__length1, (GDestroyNotify) g_free), NULL);
	_tmp8_ = g_variant_new_boolean (FALSE);
	g_variant_ref_sink (_tmp8_);
	_tmp9_ = _tmp8_;
	_tmp10_ = g_simple_action_new_stateful ("toggle-help", NULL, _tmp9_);
	_tmp11_ = _tmp10_;
	_g_variant_unref0 (_tmp9_);
	_data1_->toggle_help_action = _tmp11_;
	...
	_tmp12_ = self->hide_help_accelerator;
	_tmp13_ = g_strdup (_tmp12_);
	_tmp14_ = g_new0 (gchar*, 1 + 1);
	_tmp14_[0] = _tmp13_;
	_tmp15_ = _tmp14_;
	_tmp15__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.toggle-help", _tmp15_);
	_tmp15_ = (_vala_array_free (_tmp15_, _tmp15__length1, (GDestroyNotify) g_free), NULL);
	_tmp16_ = g_variant_new_boolean (TRUE);
	g_variant_ref_sink (_tmp16_);
	_tmp17_ = _tmp16_;
	_tmp18_ = g_simple_action_new_stateful ("toggle-tree", NULL, _tmp17_);
	_tmp19_ = _tmp18_;
	_g_variant_unref0 (_tmp17_);
	_data1_->toggle_tree_action = _tmp19_;
	...
	_tmp20_ = self->hide_tree_accelerator;
	_tmp21_ = g_strdup (_tmp20_);
	_tmp22_ = g_new0 (gchar*, 1 + 1);
	_tmp22_[0] = _tmp21_;
	_tmp23_ = _tmp22_;
	_tmp23__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.toggle-tree", _tmp23_);
	_tmp23_ = (_vala_array_free (_tmp23_, _tmp23__length1, (GDestroyNotify) g_free), NULL);
	_tmp24_ = g_simple_action_new ("undo", NULL);
	undo_action = _tmp24_;
	...
	_tmp25_ = self->undo_accelerator;
	_tmp26_ = g_strdup (_tmp25_);
	_tmp27_ = g_new0 (gchar*, 1 + 1);
	_tmp27_[0] = _tmp26_;
	_tmp28_ = _tmp27_;
	_tmp28__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.undo", _tmp28_);
	_tmp28_ = (_vala_array_free (_tmp28_, _tmp28__length1, (GDestroyNotify) g_free), NULL);
	_tmp29_ = g_simple_action_new ("redo", NULL);
	redo_action = _tmp29_;
	...
	_tmp30_ = self->redo_accelerator;
	_tmp31_ = g_strdup (_tmp30_);
	_tmp32_ = g_new0 (gchar*, 1 + 1);
	_tmp32_[0] = _tmp31_;
	_tmp33_ = _tmp32_;
	_tmp33__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.redo", _tmp33_);
	_tmp33_ = (_vala_array_free (_tmp33_, _tmp33__length1, (GDestroyNotify) g_free), NULL);
	_tmp34_ = g_simple_action_new ("append", NULL);
	append_action = _tmp34_;
	...
	_tmp35_ = self->append_node_accelerator;
	_tmp36_ = g_strdup (_tmp35_);
	_tmp37_ = g_new0 (gchar*, 1 + 1);
	_tmp37_[0] = _tmp36_;
	_tmp38_ = _tmp37_;
	_tmp38__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.append", _tmp38_);
	_tmp38_ = (_vala_array_free (_tmp38_, _tmp38__length1, (GDestroyNotify) g_free), NULL);
	_tmp39_ = g_simple_action_new ("new", NULL);
	new_action = _tmp39_;
	...
	_tmp40_ = self->file_new_accelerator;
	...
	_tmp44_ = g_simple_action_new ("export", NULL);
	export_action = _tmp44_;
	...
	_tmp45_ = self->file_export_accelerator;
	_tmp46_ = g_strdup (_tmp45_);
	_tmp47_ = g_new0 (gchar*, 1 + 1);
	_tmp47_[0] = _tmp46_;
	_tmp48_ = _tmp47_;
	_tmp48__length1 = 1;
	gtk_application_set_accels_for_action ((GtkApplication*) self, "app.export", _tmp48_);
